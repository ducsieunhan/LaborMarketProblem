...
//Bài toán thị trường lao động mô phỏng quá trình phân bổ nhân viên đến các công ty sao cho tối ưu hóa độ hài lòng của nhân viên và công ty,
//tuân thủ các ràng buộc về số lượng nhân viên và công ty.
// Cụ thể, mỗi nhân viên có thể ứng tuyển vào tối đa một công ty và mỗi công ty có thể tuyển dụng tối đa hai nhân viên.
//Độ hài lòng của nhân viên phụ thuộc vào 2 yếu tố chính: mức lương, khoảng cách từ nhà đến công ty
//và độ hài lòng của công ty phụ thuộc vào mức độ phù hợp về kỹ năng giữa nhân viên và công ty.
